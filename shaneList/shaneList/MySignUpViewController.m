...
//    [self.signUpView.dismissButton setImage:[UIImage imageNamed:@"ExitDown.png"] forState:UIControlStateHighlighted];
    ...
    [self.signUpView.signUpButton setBackgroundImage:[UIImage imageNamed:@"shanesignUp.png"] forState:UIControlStateNormal];
    [self.signUpView.signUpButton setBackgroundImage:[UIImage imageNamed:@"shanesignUpDown.png"] forState:UIControlStateHighlighted];
